...
from core.AC_trainer import ReplayBuffer, ACTrainer
...
if __name__ == "__main__":
    ...
    trainer_path = os.path.join(log_dir, "AC")
    progress_path = os.path.join(log_dir, "AC", "progress.csv")
    ...
    for t in tqdm.trange(int(args.max_steps), desc="Training Step"):
        ...
        if done:
            ...
            if t - log_count * args.log_freq > args.log_freq:
                ...
                pretty_print({
                    "===== AC Training Step {} =====".format(t): stats
                })
